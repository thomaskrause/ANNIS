...
ALTER TABLE _rank ADD CONSTRAINT "_UNIQ__rank_pre" UNIQUE (pre, component_ref, type_ref, corpus_ref);
ALTER TABLE _rank ADD CONSTRAINT "_UNIQ__rank_post" UNIQUE (post, component_ref, type_ref, corpus_ref);
